...
class Assignments extends Document
{
    ...
    protected ?string $heading = 'Assignments';
    ...
    protected static ?string $slug = '/assignments/{folderId?}';
    ...
    public static function getNavigationItems(): array
    {
        return [
            NavigationItem::make(static::getNavigationLabel())
                ...
                ->isActiveWhen(fn (): bool => request()->routeIs("filament.admin.pages..assignments.*"))

...
class LabExercises extends Document
{
    ...
    protected ?string $heading = 'Lab Exercises';

    protected static ?string $navigationLabel = 'Lab Exercises';

    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static ?string $navigationGroup = 'Documents';

    protected static ?string $slug = '/lab-exercises/{folderId?}';

    public function mount(string $folderId = null): void
    {
        $this->folder_id = $folderId == null ? 6 : intval($folderId);
    ...
    public static function getNavigationItems(): array
    {
        return [
            NavigationItem::make(static::getNavigationLabel())
                ...
                ->isActiveWhen(fn (): bool => request()->routeIs("filament.faculty.pages..lab-exercises.*"))

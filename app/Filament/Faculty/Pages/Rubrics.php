...
class Rubrics extends Document
{
    ...
    protected ?string $heading = 'Rubrics';

    protected static ?string $navigationLabel = 'Rubrics';

    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static ?string $navigationGroup = 'Documents';

    protected static ?string $slug = '/rubrics/{folderId?}';

    public function mount(string $folderId = null): void
    {
        $this->folder_id = $folderId == null ? 11 : intval($folderId);
    ...
    public static function getNavigationItems(): array
    {
        return [
            NavigationItem::make(static::getNavigationLabel())
                ...
                ->isActiveWhen(fn (): bool => request()->routeIs("filament.faculty.pages..rubrics.*"))

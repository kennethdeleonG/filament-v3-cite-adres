...
class GradingSheets extends Document
{
    ...
    protected ?string $heading = 'Grading Sheets';
    ...
    protected static ?string $slug = '/grading-sheets/{folderId?}';

    public function mount(string $folderId = null): void
    {
        $this->folder_id = $folderId == null ? 10 : intval($folderId);
    ...
    public static function getNavigationItems(): array
    {
        return [
            NavigationItem::make(static::getNavigationLabel())
                ...
                ->isActiveWhen(fn (): bool => request()->routeIs("filament.faculty.pages..grading-sheets.*"))
